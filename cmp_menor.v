module cmp_menor(in1, in2, out);
    ...
    //Portas pra verificar se o bit de in1 é menor que o de in2
    and(m[0], in2[0], n_in1[0]);
    and(m[1], in2[1], n_in1[1]);
    and(m[2], in2[2], n_in1[2]);
    and(m[3], in2[3], n_in1[3]);
    and(m[4], in2[4], n_in1[4]);
    and(m[5], in2[5], n_in1[5]);
    and(m[6], in2[6], n_in1[6]);
    and(m[7], in2[7], n_in1[7]);
